...
async function verify(client, payload, paymentRequirements) {
  ...
  if ((0, import_viem3.getAddress)(payload.payload.authorization.to) !== (0, import_viem3.getAddress)(paymentRequirements.payTo)) {
    return {
      isValid: false,
...
async function settle(wallet, paymentPayload, paymentRequirements) {
  ...
  const { signature } = (0, import_viem3.parseErc6492Signature)(paymentPayload.payload.signature);
