import {
  ...
  signPaymentHeader
} from "./chunk-5WSSSSUL.mjs";
import {
  authorizationTypes,
  getNetworkId
} from "./chunk-ZGGQSJFE.mjs";
import {
  __export,
  config,
  getERC20Balance,
...
async function settle(wallet, paymentPayload, paymentRequirements) {
  ...
  const { signature } = parseErc6492Signature(paymentPayload.payload.signature);
...
//# sourceMappingURL=chunk-ODRCEV7M.mjs.map