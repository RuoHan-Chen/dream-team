...
var EvmECDSASignatureRegex = /^0x[0-9a-fA-F]{130}$/;
var Evm6492SignatureRegex = /^0x[0-9a-fA-F]+6492649264926492649264926492649264926492649264926492649264926492$/;
var schemes = ["exact"];
var x402Versions = [1];
var ErrorReasons = [
  "insufficient_funds",
...
var ExactEvmPayloadSchema = z3.object({
  signature: z3.string().regex(EvmECDSASignatureRegex).or(z3.string().regex(Evm6492SignatureRegex)),
...
//# sourceMappingURL=chunk-ZGGQSJFE.mjs.map